...
Cortex is free for both personal and commercial use under the Apache License 2.0. You may:
...
4. Include the NOTICE file if present

---

## Patent Grant

The Apache License 2.0 includes an explicit patent grant. Each contributor grants you a patent license for their contributions. If you sue any contributor claiming the software infringes your patents, your license to use the software terminates.

This provides strong protection for both users and contributors.

---

## Trademark

"Cortex" is not a registered trademark. You are free to use the name "Cortex" when referring to this software in accordance with Section 6 of the Apache License (reasonable and customary use in describing the origin of the Work).
