...
import pytest
from tests.helpers import generate_test_user_id, TestCleanup
...
async def test_diagnose_users_list(cortex_client):
    ...
    # Verify it exists
    print(f"2. Verifying user exists...")
    ...
    try:
        ...
        if count == 0:
            print(f"   ⚠ No users were purged - investigating why...")
