...
**Python SDK API Fixes**:
4. ✅ `cortex/agents/__init__.py` - Fixed agentId parameter, added convert_convex_response
5. ✅ `cortex/contexts/__init__.py` - Added convert_convex_response, filter_none_values
6. ✅ `cortex/facts/__init__.py` - Added convert_convex_response, filter_none_values
7. ✅ `cortex/memory_spaces/__init__.py` - Removed includeStats
8. ✅ `cortex/mutable/__init__.py` - Removed dryRun, fixed deleteKey function name

**Test Fixes**:
9. ✅ Fixed role "assistant" → "agent" in tests
10. ✅ Fixed MemorySource timestamp requirements
11. ✅ Fixed AgentRegistration/ContextInput parameters
12. ✅ Fixed Mutable API signatures
13. ✅ Fixed dict vs object access patterns
...
4. ✅ agents/__init__.py - agentId param, convert_convex_response
5. ✅ contexts/__init__.py - convert_convex_response, filter_none_values
6. ✅ facts/__init__.py - convert_convex_response, filter_none_values
7. ✅ memory_spaces/__init__.py - Removed includeStats
8. ✅ mutable/__init__.py - Removed dryRun, deleteKey function name
