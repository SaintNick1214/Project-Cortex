...
⚠️ **Warning:** Existing data may be overwritten.
...
```bash
cortex db clear
# → Prompts: "Clear ALL data from local?"
```
...
```bash
cortex users delete user-123 --cascade
# → Prompts: Type "user-123" to confirm cascade deletion
```
...
```bash
cortex users delete user-123 --cascade --verify
# → Verifies all user data was deleted
...
- [Getting Started: Installation](../01-getting-started/02-installation.md)
- [Getting Started: Five Minute Quickstart](../01-getting-started/03-five-minute-quickstart.md)
- [Getting Started: Configuration](../01-getting-started/05-configuration.md)
...
- [Memory Operations](../03-api-reference/02-memory-operations.md)
- [Conversation Operations](../03-api-reference/03-conversation-operations.md)
- [User Operations](../03-api-reference/04-user-operations.md)
- [Memory Space Operations](../03-api-reference/11-memory-space-operations.md)
- [Facts Operations](../03-api-reference/12-facts-operations.md)
