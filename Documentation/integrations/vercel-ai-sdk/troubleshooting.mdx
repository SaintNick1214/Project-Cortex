...
**Note:** The actual error message includes additional configuration help text to guide users.
...
**Note:** The AI SDK supports versions 3, 4, 5, and 6 (`^3.0.0 || ^4.0.0 || ^5.0.0 || ^6.0.0`).
