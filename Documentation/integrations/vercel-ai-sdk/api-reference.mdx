...
| `contextInjectionStrategy` | 'system'\|'user'\|'custom'              | ❌       | 'system'       | Where to inject context          |
...
| `beliefRevision`          | object \| false                         | ❌       | undefined      | Belief revision configuration    |
| `enableStreamMetrics`     | boolean                                 | ❌       | true           | Enable streaming metrics         |
...
> **Note:** AI SDK v6 compatibility layer APIs (including `isV6Available`, `createMemoryPrepareCall`, `CortexCallOptions`, etc.) are documented separately. See the [AI SDK v6 Integration Guide](./v6-integration) for details.

## See Also

- [Getting Started](./getting-started) - Setup tutorial
- [Advanced Usage](./advanced-usage) - Custom patterns
- [Memory Spaces](./memory-spaces) - Multi-tenancy
- [Hive Mode](./hive-mode) - Cross-app memory
- [Troubleshooting](./troubleshooting) - Common issues
- [Memory Operations](/api-reference/memory-operations) - Core SDK operations
