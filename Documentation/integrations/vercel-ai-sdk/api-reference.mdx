...
<Callout type="info">
AI SDK v6 compatibility layer APIs (including `isV6Available`, `createMemoryPrepareCall`, `CortexCallOptions`, etc.) are documented separately. See the [AI SDK v6 Integration Guide](/integrations/vercel-ai-sdk/v6-integration) for details.
</Callout>
