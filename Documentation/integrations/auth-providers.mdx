...
- See [Auth Context API](../03-api-reference/15-auth-context-api)
...
- **[Auth Context API](../03-api-reference/15-auth-context-api)** - Complete API reference
- **[Authentication](../02-core-features/18-authentication)** - Core concepts guide

### Related Features

- **[Isolation Boundaries](../02-core-features/17-isolation-boundaries)** - Multi-layer isolation model
- **[Sessions Management](../02-core-features/14-sessions-management)** - Session lifecycle
- **[User Profiles](../02-core-features/03-user-profiles)** - User management + GDPR
- **[Memory Spaces](../02-core-features/01-memory-spaces)** - Space isolation

### API Reference

- **[Sessions Operations API](../03-api-reference/14-sessions-operations)** - Session API
- **[User Operations API](../03-api-reference/04-user-operations)** - User API
- **[Memory Space Operations API](../03-api-reference/11-memory-space-operations)** - Space API
