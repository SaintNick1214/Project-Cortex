...
- **[Auth Context API](/api-reference/auth-context-api)** - Complete API reference
- **[Authentication](/security/authentication)** - Core concepts guide

### Related Features

- **[Isolation Boundaries](/security/isolation-boundaries)** - Multi-layer isolation model
- **[Sessions Management](/advanced-topics/sessions-management)** - Session lifecycle
- **[User Profiles](/core-features/user-profiles)** - User management + GDPR
- **[Memory Spaces](/core-features/memory-spaces)** - Space isolation

### API Reference

- **[Sessions Operations API](/api-reference/sessions-operations)** - Session API
- **[User Operations API](/api-reference/user-operations)** - User API
- **[Memory Space Operations API](/api-reference/memory-space-operations)** - Space API
