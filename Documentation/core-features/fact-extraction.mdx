...
- **[Facts vs Conversations Trade-offs](../07-advanced-topics/03-facts-vs-conversations)** - Detailed comparison
- **[Graph Database Integration](../07-advanced-topics/02-graph-database-integration)** - Add graph for entity relationships
- **[Semantic Search](./semantic-search)** - Search facts efficiently
- **[Immutable Store API](../03-api-reference/07-immutable-store-api)** - Storage layer for facts
