...
**When to add graph DB:** If context hierarchies exceed 10 levels or need complex pattern matching, consider [Graph Database Integration](../07-advanced-topics/02-graph-database-integration). For advanced built-in patterns, see [Graph Capabilities](../07-advanced-topics/01-graph-capabilities).
...
See [Graph Operations API](../03-api-reference/13-graph-operations) for complete graph integration.

---

## Next Steps

- **[Context Operations API](../03-api-reference/05-context-operations)** - Complete API reference
- **[A2A Communication](./a2a-communication)** - Agent-to-agent messaging
- **[Graph Integration](./graph-integration)** - Advanced graph capabilities
- **[Memory Spaces](./memory-spaces)** - Understanding isolation
- **[Governance Policies](../03-api-reference/10-governance-policies-api)** - Retention rules for contexts
