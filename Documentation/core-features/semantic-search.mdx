...
See **[Fact Integration](./fact-integration)** for complete documentation on automatic fact extraction in Memory API.
See **[Fact Extraction](./fact-extraction)** for the Belief Revision System details.

## Next Steps

- **[Memory Orchestration](./memory-orchestration)** - The heart of Cortex: understand how all layers work together
- **[User Profiles](./user-profiles)** - Manage user context across agents
- **[Context Chains](./context-chains)** - Hierarchical agent coordination
- **[Fact Integration](./fact-integration)** - Extract structured knowledge from conversations
- **[Vector Embeddings](../04-architecture/04-vector-embeddings)** - Embedding models and dimension strategies
