...
- **[Installation Guide](../01-getting-started/02-installation)** - Set up Cortex SDK
- **[Fact Extraction](./fact-extraction)** - Optimize memory with facts
- **[Graph Integration](../07-advanced-topics/02-graph-database-integration)** - Add graph queries
- **[API Reference](../03-api-reference/01-overview)** - Complete API docs
