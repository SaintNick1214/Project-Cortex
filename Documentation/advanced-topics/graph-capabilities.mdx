...
> **Note:** This document covers advanced graph patterns and performance analysis. For basic context chain operations (creating, updating, querying), see **[Context Chains](../02-core-features/04-context-chains)**.
...
- **[Context Chains](../02-core-features/04-context-chains)** - Basic hierarchical operations
- **[A2A Communication](../02-core-features/05-a2a-communication)** - Agent communication patterns
- **[Graph Operations API](../03-api-reference/13-graph-operations)** - Complete API reference
