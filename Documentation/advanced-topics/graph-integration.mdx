...
- **[Fact Extraction](./fact-extraction)** - Extract entities for graph
- **[Context Chains](./context-chains)** - Hierarchical contexts in graph
- **[Semantic Search](./semantic-search)** - Combine with graph enrichment
- **[Memory Spaces](./memory-spaces)** - Graph isolation boundaries

See **[Graph Operations API](../03-api-reference/13-graph-operations)** for complete API documentation.
