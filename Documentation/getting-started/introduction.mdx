...
<Callout type="tip" title="Auth Integration">
  Cortex is **framework-agnostic** - it works with whatever auth system you already use. Just extract `userId` and optionally `tenantId`, no complex integration needed. See [Authentication](/core-features/authentication).
</Callout>
...
<FeatureGrid>
  ...
  <FeatureCard 
    icon="mcp"
    title="MCP Server" 
    description="Cross-application memory for Cursor, Claude Desktop, and custom tools."
    href="/core-features/mcp-server"
  />
</FeatureGrid>

<Callout type="tip" title="Explore More Features">
  See also: [User Profiles](/core-features/user-profiles), [Fact Extraction](/core-features/fact-extraction), [Analytics](/core-features/access-analytics), [Streaming](/core-features/streaming-support), and [Resilience Layer](/core-features/resilience-layer).
</Callout>
