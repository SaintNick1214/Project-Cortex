...
<FeatureGrid>
  ...
  <FeatureCard
    icon="users"
    title="Multi-Tenancy"
    description="Built-in tenantId for SaaS platform isolation (auto-injected from AuthContext)"
  />
  <FeatureCard
    icon="bot"
    title="Hive Mode"
  ...
  <FeatureCard
    ...
    description="Intelligent fact management with conflict resolution (v0.24.0+)"
  />
  <FeatureCard
    icon="lock"
