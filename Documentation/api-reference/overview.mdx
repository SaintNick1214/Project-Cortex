...
- **[Memory Operations](./memory-operations)** - The main API you'll use
...
- **[Memory Space Operations](./memory-space-operations)** - Memory space management
...
- **[Conversation Operations](./conversation-operations)** - Layer 1a (ACID)
...
- **[User Operations](./user-operations)** - User profiles + GDPR ✅
...
- **[Sessions Operations](./sessions-operations)** - Session lifecycle management ✅
...
- **[Auth Integration](../08-integrations/auth-providers)** - Authentication context
...
- **[Agent Management](./agent-management)** - Agent registry ⚠️ (superseded by Memory Spaces)
...
- **[Context Operations](./context-operations)** - Workflow coordination ✅
...
- **[A2A Communication](./a2a-communication)** - Inter-agent messaging
...
- **[Immutable Store](./immutable-store-api)** - Layer 1b
...
- **[Mutable Store](./mutable-store-api)** - Layer 1c
...
- **[Facts Operations](./facts-operations)** - Layer 3 Facts Store
...
- **[Governance Policies](./governance-policies-api)** - Retention rules & compliance
...
- **[Graph Operations](./graph-operations)** - Graph database integration (v0.7.0+)
...
- **[Types & Interfaces](../05-reference/01-types-interfaces)** - TypeScript definitions
- **[Error Handling](../05-reference/02-error-handling)** - Error codes and debugging
...
**See**: [Facts Operations API - Belief Revision](./facts-operations.md#belief-revision-system-v0240)
...
→ [Memory Operations](./memory-operations.md#remember) - `cortex.memory.remember()`

**Search agent memories:**
→ [Memory Operations](./memory-operations.md#search) - `cortex.memory.search()`

**Manage user profiles:**
→ [User Operations](./user-operations) - `cortex.users.*`

**Delete user data (GDPR):**
→ [User Operations](./user-operations.md#delete) - `cortex.users.delete({ cascade: true })`

**Track multi-agent workflows:**
→ [Context Operations](./context-operations) - `cortex.contexts.*`

**Send agent-to-agent messages:**
→ [A2A Communication](./a2a-communication) - `cortex.a2a.send()`

**Store shared knowledge:**
→ [Immutable Store](./immutable-store-api) - `cortex.immutable.store()`

**Store live data (inventory, config):**
→ [Mutable Store](./mutable-store-api) - `cortex.mutable.set()`

**Set retention policies:**
→ [Governance Policies](./governance-policies-api) - `cortex.governance.*`

**Manage user sessions:**
→ [Sessions Operations](./sessions-operations) - `cortex.sessions.*`

**Store and query facts:**
→ [Facts Operations](./facts-operations) - `cortex.facts.*`

**Integrate graph database:**
→ [Graph Operations](./graph-operations) - GraphAdapter and GraphSyncWorker

**See all TypeScript types:**
→ [Types & Interfaces](../05-reference/01-types-interfaces)

**Debug an error:**
→ [Error Handling](../05-reference/02-error-handling)
...
→ [Immutable Store](./immutable-store-api)

**Layer 1c (Mutable Store):**
→ [Mutable Store](./mutable-store-api)

**Layer 2 (Vector Index):**
→ [Memory Operations](./memory-operations) - `cortex.vector.*`

**Layer 3 (Facts Store):**
→ [Facts Operations](./facts-operations) - `cortex.facts.*`

**Layer 4 (Convenience API):**
→ [Memory Operations](./memory-operations) - `cortex.memory.*`
...
- **[Memory Operations](./memory-operations)** - Most comprehensive guide
- **[Facts Operations](./facts-operations)** - Structured knowledge and Belief Revision
- **[Sessions Operations](./sessions-operations)** - Session lifecycle management
- **[Types & Interfaces](../05-reference/01-types-interfaces)** - TypeScript reference
- **[Error Handling](../05-reference/02-error-handling)** - Debugging guide
...
1. Check [Error Handling](../05-reference/02-error-handling) for known issues
...
**New to Cortex?**
→ Start with [Memory Operations](./memory-operations) - the main API

**Building multi-agent systems?**
→ Read [Context Operations](./context-operations) and [A2A Communication](./a2a-communication)

**Need GDPR compliance?**
→ Check [User Operations](./user-operations.md#delete) for cascade deletion

**Working with facts and knowledge?**
→ Explore [Facts Operations](./facts-operations) and the Belief Revision System

**Managing user sessions?**
→ Check [Sessions Operations](./sessions-operations) for activity tracking

**Working with shared data?**
→ Explore [Immutable Store](./immutable-store-api) and [Mutable Store](./mutable-store-api)

**Integrating graph databases?**
→ Review [Graph Operations](./graph-operations) for Neo4j/Memgraph integration

**TypeScript user?**
→ Review [Types & Interfaces](../05-reference/01-types-interfaces) for complete definitions

---

**Ready to build?** Head to [Memory Operations](./memory-operations) →
