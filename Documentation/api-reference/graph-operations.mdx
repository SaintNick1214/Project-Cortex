...
See [Graph Database Integration Guide](../07-advanced-topics/02-graph-database-integration) for complete setup.
...
- **[Graph Database Integration](../07-advanced-topics/02-graph-database-integration)** - Complete integration guide (setup, selection, and patterns)
