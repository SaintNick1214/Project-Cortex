...
**See also:** [Memory Operations - Automatic Fact Revision](./memory-operations.md#automatic-fact-revision-in-remember-v0240)
...
- **[Fact Integration Guide](../02-core-features/11-fact-integration)** - Extraction strategies and patterns
- **[Memory Operations API](./memory-operations)** - Memory API integration
- **[Semantic Search Guide](../02-core-features/02-semantic-search)** - Using facts in search
- **[Graph Database Integration](../07-advanced-topics/02-graph-database-integration)** - Advanced graph queries
