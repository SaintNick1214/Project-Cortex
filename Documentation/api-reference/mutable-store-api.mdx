...
<APITable
  parameters={[
    ...
    { name: "options", type: "SetMutableOptions", required: false, description: "Additional options including syncToGraph (boolean) to sync operation to graph database" },
  ]}
/>
...
<APITable
  parameters={[
    { name: "namespace", type: "string", required: true, description: "Namespace" },
    { name: "key", type: "string", required: true, description: "Key" },
    { name: "options", type: "DeleteMutableOptions", required: false, description: "Additional options including syncToGraph (boolean) to sync deletion to graph database" },
  ]}
/>
